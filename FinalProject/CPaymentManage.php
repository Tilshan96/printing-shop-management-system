<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
	  ...
	  <div class="bgimg" style="position:absolute;top:7px; left:310px;border:2px solid black;width:1035;height:980">
        ...
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Name with Initials :&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;What you Order : &nbsp</label>
        <input type="text" name="t10"><br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp&nbsp&nbsp
        </div>
        </div><br>
        ...
        <input type="text" name="t17"><br><br>
        </div>
        </div><br>
