<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
	  ...
	  <div class="bgimg" style="position:absolute;top:7px; left:310px;border:2px solid black;width:1035;height:980">
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Attachments :&emsp;&emsp;&emsp;&emsp;</label>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Date that want the order :&emsp;</label>
		<input type="text" name="t19">
        </div>
        </div><br>
        
		&emsp;&emsp;<input type="submit" name="s2" value="Order" >&emsp;&emsp;
