<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
	  ...
	  <div class="bgimg" style="position:absolute;top:7px; left:310px;border:2px solid black;width:1035;height:980">
		...
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Name with Initials :&emsp;</label>
		...
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Contact :&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Payment :&emsp;&emsp;&emsp;&emsp;&nbsp&nbsp</label>
		...
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Slip Attachment :&emsp;&emsp;&emsp; </label>
