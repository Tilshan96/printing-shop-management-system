<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
	  ...
	  <div class="bgimg" style="position:absolute;top:7px; left:310px;border:2px solid black;width:1035;height:980">
		...
		<h2><center>Quatation Details</center></h2>
		
		<div class="row">
		
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;NICNo :&emsp;&nbsp</label>
		<input type="text" name="t1">
        </div>
		
        </div><br><div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Name :&emsp;&emsp; </label>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Did you want a Quatation :&emsp;</label>
		<input type="text" name="t10">&emsp;&emsp;
        </div>
        </div><br>
        
		&emsp;&emsp;<input type="submit" name="s2" value="Submit" >&emsp;&emsp;
